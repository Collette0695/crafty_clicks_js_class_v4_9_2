...
function CraftyPostcodeClass () {
	this.config = { 
		...
		access_token	: '51f26-b1ead-14c31-02be3', // specify access token here to use the direct JS method,  lookup_url must be set to 'http://pcls1.craftyclicks.co.uk/lookup_js.php'
